package com.book.ireader.ui.dialog;
...
import com.book.ireader.widget.page.PageStyle;
    ...
    private void initClick() {
        ...
        mIvBrightnessMinus.setOnClickListener(
                (v) -> {
                    ...
                    com.book.ireader.utils.BrightnessUtils.setBrightness(mActivity, progress);
                }
        );
        ...
        mCbBrightnessAuto.setOnCheckedChangeListener(
                (buttonView, isChecked) -> {
                    if (isChecked) {
                        //获取屏幕的亮度
                        com.book.ireader.utils.BrightnessUtils.setBrightness(mActivity, com.book.ireader.utils.BrightnessUtils.getScreenBrightness(mActivity));
                    } else {
                        //获取进度条的亮度
                        com.book.ireader.utils.BrightnessUtils.setBrightness(mActivity, mSbBrightness.getProgress());
                    }
        ...
        mCbFontDefault.setOnCheckedChangeListener(
                (buttonView, isChecked) -> {
                    if (isChecked) {
                        int fontSize = com.book.ireader.utils.ScreenUtils.dpToPx(DEFAULT_TEXT_SIZE);
                        mTvFont.setText(fontSize + "");
                        mPageLoader.setTextSize(fontSize);
                    }
                }
